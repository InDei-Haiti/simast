...
<!--<div class="pagebox"> <span class="pgbs"></span>
	 ...
	 -->
    <!--<div class="cleanbox" style="display:none;float:left;margin-right: 15px;">
        <span class="fmonitor fmbox" ></span>
        <input type="button" class="button fclean" onclick="cleanAllF();" disabled="disabled" value="Clear Search">
    </div>-->
<!--</div>-->
<div id="mholder" class="toleft mtab" style="">
    <table class="" id="rtable" border="0" style="display:none;" cellpadding="2" cellspacing="1">
