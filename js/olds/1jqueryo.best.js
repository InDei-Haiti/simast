...
(function (a) {
    ...
    a.fn.sSelect = function (b) {
        return this.each(function () {
            ...
            var m = a.extend(j, b), e = a(this), k = a('<div class="selectedTxt"></div>'),
                s = a('<div class="newListSelected" tabindex="0"></div>'), A = a('<ul class="newList"></ul>'), u = -1,
                d = -1, n = [], x = false, h = "", w = false;
            s.insertAfter(e);
            k.prependTo(s);
            A.appendTo(s);
            e.hide();
