			...
			.each(function(index){
				...
				_Cols.length && $(o.dragCells,this)
					.each(function(index){
						...
						holder=jQuery(this).innerHeight(true)-2;
						//$('<div class="'+o.classHandler+'" title="'+ o.title+'"></div>')
						thh=jQuery(this).html();
						jQuery(this).html('<div class="handle_div1 kiketable-th-text " title="'+ o.title+'"><div class="handle_div2"></div>'+thh+'</div>');
						$('div.handle_div2',this)	
							//.prependTo(this)
							.each(function(){
								//
								// global properties
							...
							.bind( 'dragstart', function(e){ 
								...
								this.cell_height = this.$td.outerHeight(true);
							...
							.bind( 'dragend', function(e){ 
								if (!o.dragMove){
									...
									// change table width (if not fixed) 
									jQuery(this.col).width(e.dragProxy.style.width);
