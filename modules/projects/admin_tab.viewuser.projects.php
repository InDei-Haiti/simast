...
global $a, $addPwT, $AppUI, $buffer, $company_id, $department, $min_view, $m, $priority, $projects, $tab, $user_id, $orderdir, $orderby, $countryBuffer;
...
<tr>
	...
	-->
	<th nowrap="nowrap">
		<a href="?m=<?php echo $m;?><?php echo (isset($a) ? '&a='.$a : '') ;?><?php echo (isset($extraGet) ? $extraGet : '') ;?>&orderby=company_name" class="hdr"><?php echo $AppUI->_('Agency');?></a>
	</th>
	<th nowrap="nowrap">
