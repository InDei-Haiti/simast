...
$pdf->ezText( "\n" . safe_utf8_decode($AppUI->_('Project Upcoming Activity Report')), 12 );
$pdf->ezText( "$pname", 15 );
$pdf->ezText( safe_utf8_decode($AppUI->_('Activity Due to be Completed By')) . " " . $next_week->format($df) , 10);
$pdf->ezText( "\n" );
$pdf->selectFont( "$font_dir/Helvetica.afm" );
$title = null;
$options = array(
...
$pdfdata = array();
$columns = array();
$columns[] = "<b>" . safe_utf8_decode($AppUI->_('Activity Name')). "</b>";
