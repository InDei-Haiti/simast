...
<table width="100%" border="0" cellpadding="3" cellspacing="3" class="std">
	...
	<tr>
		...
		<td align="left"><input type="File" class="form-control" name="vcf" style="width:280px" accept="text/x-vcard"></td>
	</tr>
	<tr>
		<td align="right" colspan="2" nowrap="nowrap"><input type="submit" class="button ce pi ahr" value="<?php echo $AppUI->_('submit'); ?>"/></td>
	</tr>
	</form>
</table>
