 ...
 * @property {String} [progressColor=green] Specifies color of progress background
 */
 ...
 * @return {GControl}
 */    
function ProgressbarMapControl(map, width, pcolor) { 
  this.map_ = map; 
  this.width_ = width; 
  this.pcolor_ = pcolor;
}
...
ProgressbarMapControl.prototype.initialize = function () {
  ...
  container_.innerHTML = '<div style="position:absolute;width:100%;border:5px;'
    ...
    + '<div style="background-color:' + this.pcolor_ + ';height:100%;" id="geo_progress"></div>';
...
function ProgressbarControl(map, opt_opts) {
  ...
  this.pcolor_ = this.options_.pcolor || 'green';

  this.control_ = new ProgressbarMapControl(map, this.width_,this.pcolor_);
  this.map_ = map;
