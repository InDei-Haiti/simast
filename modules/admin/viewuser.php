...
// setup the title block
	...
	$titleBlock = new CTitleBlock( 'View User', '', $m, "$m.$a" );
	if ($canRead) {
	  $titleBlock->addCrumb( "?m=admin", "users list" );
	}
	if ($canEdit || $user_id == $AppUI->user_id) {
	      ...
	      $titleBlock->addCell('<td align="right" width="100%"><input type="button" class="button ce pi ahr" value="'.$AppUI->_('add user').'" onClick="javascript:window.location=\'./index.php?m=admin&a=addedituser\';" /></td>');
	}
	$titleBlock->show();
?>
...
<table border="0" cellpadding="4" cellspacing="0" width="100%" class="mtab">
<tr valign="top">
	<td width="50%">
		...
		<tr>
			<td align="right" nowrap><?php echo $AppUI->_('Agency');?>:</td>
