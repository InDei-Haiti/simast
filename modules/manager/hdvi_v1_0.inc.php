...
<form method="POST" action="?m=manager&a=hdvi">
	<table class="fldtab">
		<tr>
		...
		<tr>
			<td colspan="2">Forms households: <!-- <input type="text" readonly="readonly"
				id="household" /> <input type="text" name="householdid"
				id="householdid" /> -->
				<select id="household" name="householdid" class="chosen">
				</select>
			</td>
		</tr>
		<tr>
			<td colspan="2"> Offset <input type="number" name="from" value="0" /> Limite <input type="number" name="to" value="1000" />
			</td>
		</tr>
		<tr>
