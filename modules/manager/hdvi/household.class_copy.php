...
class Household {
	...
	function processingHdvi() {
		...
		$prisk_3_2 = 0;
		foreach ( $this->members as $member ) {
			if (!($member->member_fld_read == 2 || $member->member_fld_write == 2) && $member->member_fld_age >= 21 && 
					$member->member_fld_level_edu != null && $member->member_fld_level_edu <= 7) {
		...
		foreach ( $this->members as $member ) {
			...
			$aedu = null;
			if (($member->member_fld_level_edu != null && $member->member_fld_level_edu <= 2 ) || 
					($member->member_fld_act_edu !=null && $member->member_fld_act_edu <= 3))
				$aedu = 0;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 3) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 4)) && $aedu == null)
				$aedu = 1;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 4) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 5)) && $aedu == null)
				$aedu = 2;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 5) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 6)) && $aedu == null)
				$aedu = 3;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 6) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 7)) && $aedu == null)
				$aedu = 4;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 7) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 8)) && $aedu == null)
				$aedu = 5;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 8) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 9)) && $aedu == null)
				$aedu = 6;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 9) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 10)) && $aedu == null)
				$aedu = 7;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 10) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 11)) && $aedu == null)
				$aedu = 8;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 11) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 12)) && $aedu == null)
				$aedu = 9;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 12) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 13)) && $aedu == null)
				$aedu = 10;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 13) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 14)) && $aedu == null)
				$aedu = 11;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 14) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 15)) && $aedu == null)
				$aedu = 12;
			if ((($member->member_fld_level_edu!=null && $member->member_fld_level_edu == 15) || 
					($member->member_fld_act_edu != null && $member->member_fld_act_edu == 16)) && $aedu == null)
				$aedu = 13;
		...
		foreach ( $this->members as $member ) {
			...
			if ((($member->member_fld_eco_active != null &&
						$member->member_fld_eco_active >= 1 && $member->member_fld_eco_active <= 3) ||
			...
			if ((($member->member_fld_eco_active != null && $member->member_fld_eco_active >= 1 &&
						$member->member_fld_eco_active <= 3) || ($member->member_fld_eco_active != null
		...
		if($this->metro){
			...
			if($hdvi >= 0.5599004 && $step7 >= 0.37127638){
				$vulnerability = 1;
			}elseif($hdvi >= 0.63960439 && $step7 >= 0.48593339){
				$vulnerability = 2;
			}elseif($hdvi >= 0.68062776 && $step7 >= 0.66414106){
				$vulnerability = 3;
			}
		}
		...
		if($this->urbain){
			...
			if($hdvi >= 0.67673182 && $step7 >= 0.54387569){
				$vulnerability = 1;
			}elseif($hdvi >= 0.54571939 && $step7 >= 0.36966765){
				$vulnerability = 2;
			}elseif($hdvi >= 0.476289 && $step7 >= 0.23916292){
				$vulnerability = 3;
			}
		}
		...
		if($this->rural){
			...
			if($hdvi >= 0.68696195 && $step7 >= 0.72237688){
				$vulnerability = 1;
			}elseif($hdvi >= 0.59115386 && $step7 >= 0.48399004){
				$vulnerability = 2;
			}elseif($hdvi >= 0.4626534 && $step7 >= 0.27843869){
				$vulnerability = 3;
			}
		}
