...
<form name="changeMe" action="./index.php?m=system&a=billingcode" method="post">
        <?php echo arraySelect( $company_list, 'company_id', 'size="1" class="form-control" onchange="changeIt();"', $obj->task_status, true );?>
</form>
<br /><br />
...
<tr>
        <td>&nbsp;</td>
        <td><input class="form-control" type="text" name="billingcode_name" value=""></td>
        <td><input class="form-control" type="text" name="billingcode_value" value=""></td>
        <td><input class="form-control" type="text" name="billingcode_desc" value=""</td>
</tr>
