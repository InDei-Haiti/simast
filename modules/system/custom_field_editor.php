<?php
	...
	$sql = "SELECT * FROM modules WHERE mod_name IN (/*'Companies', 'Projects', 'Tasks', 'Calendar',*/ 'Clients') ORDER BY mod_ui_order";
	...
	foreach ($modules as $module){
		...
		foreach ($custom_fields as $f){
			...
			echo "&emsp;&emsp;<a href=\"?m=system&a=custom_field_addedit&module=".$module["mod_name"]."&field_id=".$f["field_id"]."\"><img src='./images/icons/stock_edit-16.png' align='center' width='16' height='16' border='0'>Edit</a>";
