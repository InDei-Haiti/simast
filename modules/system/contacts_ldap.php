...
<table border="0" cellpadding="2" cellspacing="1" width="600" class="std">
	<tr>
		...
		<td><input class="form-control" type="text" name="server" value="<?php echo $server; ?>" size="50"></td>
	</tr>
	<tr>
		<td align="right" nowrap="nowrap"><?php echo $AppUI->_('Port'); ?>:</td>
		<td><input class="form-control" type="text" name="port" value="<?php echo $port; ?>" size="4"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input class="form-control" type="text" name="bind_name" value="<?php echo $bind_name; ?>" size="50"></td>
	</tr>
	<tr>
		<td align="right" nowrap="nowrap"><?php echo $AppUI->_('Bind Password'); ?>:</td>
		<td><input class="form-control" type="password" name="bind_password" value="<?php echo $bind_password; ?>" size="25"></td>
	</tr>
	<tr>
		<td align="right" nowrap="nowrap"><?php echo $AppUI->_('Base DN'); ?>:</td>
		<td><input class="form-control" type="text" name="dn" value="<?php echo $dn; ?>" size="100"></td>
	</tr>
	<tr>
		<td align="right" nowrap="nowrap"><?php echo $AppUI->_('Filter'); ?>:</td>
		<td><input class="form-control" type="text" name="filter" value="<?php echo $filter; ?>" size="100"></td>
	</tr>
	<tr>
		<td colspan="2" align="right"><input class="button ce pi ahr" type="submit" name="test" value="<?php echo $AppUI->_('Test Connection and Query'); ?>"><input style="margin-left:20px;" class="button ce pi ahr" type="submit" name="import" value="<?php echo $AppUI->_('Import Users'); ?>"></td>
	</tr>
</table><br /><br />
<pre>
<?php
