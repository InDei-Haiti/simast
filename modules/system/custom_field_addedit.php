...
<table class="std">
	...
	<tr><td>
		...
		<input class="form-control" type="text" name="field_name" maxlength="100" value="<?php echo $field_name?>" onblur='this.value=this.value.replace(/[^a-z|^A-Z|^0-9]*/gi,"");' />
	</td></tr>
	<tr><td>
		<?php echo $AppUI->_('Field Description')?>:
		</td><td>
		<input class="form-control" type="text" name="field_description" size="40" maxlength="250" value="<?php echo $field_description?>" />
	</td></tr>
	<tr><td>
	...
	<tr><td colspan="2">
		...
		<td>
			<input class="form-control" type="text" name="field_extratags" value="<?php echo $field_extratags?>" />
		</td></tr>
	</td></tr>
	<tr><td colspan="2">
	...
	<tr><td colspan="2" align="right">
		<input class="button ce pi ahr" type="button" value="Cancel" onClick="location = '?m=system&a=custom_field_editor';" />
		<input class="button ce pi ahr" type="button" value="Save" onClick="javascript:postCustomField()" />
	</td></tr>
	</form>
</table>
</div>
