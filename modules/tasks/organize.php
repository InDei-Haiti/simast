...
if (!@$min_view) {
	$titleBlock = new CTitleBlock();//'Organize Activities', '', $m, "$m.$a");
	//$titleBlock = new CTitleBlock('Organize Activities', 'applet-48.png', $m, "$m.$a");
...
?>
		...
		<img src="./images/icons/pencil.gif" alt="Edit Activity" border="0" width="12" height="12">
		</a>
<?php } ?>
	</td>
...
echo $AppUI->_('update selected activities'); ?>"></td>
</tr>
</table>
</form>
