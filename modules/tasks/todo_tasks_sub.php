...
if ($other_users) {
	...
	<td nowrap="nowrap">
	  <label for="show_dyn_task"><?php echo $AppUI->_('Dynamic Activities'); ?></label>
	</td>
	<td>
	...
	<td nowrap="nowrap">
	  <label for="show_low_task"><?php echo $AppUI->_('Low Priority Activities'); ?></label>
	</td>
	<td>
...
sort_by_item_title('P', 'task_priority', SORT_NUMERIC); ?></th>
	<th colspan="2"><?php 
sort_by_item_title('Activity / Project', 'task_name', SORT_STRING); ?></th>
	<th nowrap><?php 
