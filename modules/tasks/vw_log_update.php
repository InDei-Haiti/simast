...
?>
      <tr>
        <td align='right'><?php echo $AppUI->_("Activity end date"); ?></td>
        <td>
...
echo (($ta) ? ' checked="checked"' : ''); ?> />
          <label for="email_assignees"><?php echo $AppUI->_('Activity Assignees'); ?></label>
...
echo (($tt) ? ' checked="checked"' : ''); ?> />
          <label for="email_task_contacts"><?php echo $AppUI->_('Activity Contacts'); ?></label>
