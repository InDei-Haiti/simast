...
if (!@$min_view) {
	//$titleBlock = new CTitleBlock('My Activities To Do', 'applet-48.png', $m, "$m.$a");
	$titleBlock = new CTitleBlock('My Activities To Do', '', $m, "$m.$a");
...
<tr>
	...
	$tabBox->add('tasks/todo_tasks_sub', 'My Activities');
