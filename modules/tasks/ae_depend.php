...
<tr>
	<td align="right" nowrap="nowrap"><label for="task_dynamic"><?php echo $AppUI->_( 'Dynamic Activity' );?></label></td>
	<td nowrap="nowrap">
...
<tr>
	...
	<td>
		<input type="checkbox" name="task_dynamic_nodelay" id="task_dynamic_nodelay" value="1" <?php if(($obj->task_dynamic > '10') && ($obj->task_dynamic < 30)) echo 'checked="checked"' ?> />
			...
			?>
			<tr>
				<td><?php echo $AppUI->_( 'All Activities' );?>:</td>
				<td><?php echo $AppUI->_( 'Activity Dependencies' );?>:</td>
			</tr>
			<tr>
				<td>
