<?php
$partShow=true;
$selects = array("fld_8" => 'select contact_id as id, CONCAT_WS(" ",contact_first_name,contact_last_name) as name from contacts  where contact_id<>"13" and contact_active="1" order by name asc',
"fld_9" => 'select contact_id as id, CONCAT_WS(" ",contact_first_name,contact_last_name) as name from contacts  where contact_id<>"13" and contact_active="1" order by name asc',
...
"fld_8" => array('title'=>'9.Social worker in charge','value'=>'preSQL','query'=>'staffName','rquery'=>'staffId'
				),
...
"fld_12" => array("title"=>"13.Last update","xtype"=>"date"));
?>