...
"fld_4" => 'select clinic_location_id as id, clinic_location as name from clinic_location order by name asc ');
...
"fld_4" => array('title'=>'5.Item','value'=>'preSQL','query'=>'locationName','rquery'=>'locationId'
				),
"fld_5" => "6.Units",
"fld_6" => "7.Price");
?>