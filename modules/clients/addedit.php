		...
		<tr>
			<td>
				<table>
					...
					<tr>
						<td align="left" nowrap><?php echo $AppUI->_('Date Of Birth');?>: <strong style="color: red">*</strong></td>
					...
					<tr>
						...
						<td>
							...
							?>-->
							<select name="client[client_administration_section]" style="width:200px;" class="text chosen" size=1 id="administration_sect">
